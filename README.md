...
Sou desenvolvedor **Full Stack**, com foco em aplicações **mobile** (React Native + Expo) e **web**. Gosto de construir produtos de ponta a ponta — do backend à interface — e estou sempre aprendendo tecnologias novas através de projetos reais.

- 🔭 Atualmente trabalhando em projetos com **React Native, Expo, Firebase e React**
- 🌱 Sempre aprimorando **TypeScript**, **Python** e boas práticas de arquitetura
- 💬 Pergunte-me sobre **React Native**, **React**, **Firebase** ou **automação em Python**
- ⚡ Fun fact: transformo ideias em apps funcionais rapidinho
...
|---|---|---|
| [Não Esqueci](https://github.com/rarpen/NaoEsqueci) | App mobile para lembretes e organização pessoal | React Native · Expo · Firebase · Zustand |
| [Marmita Fácil](https://github.com/rarpen/marmita-facil) | Plataforma para planejamento e pedido de marmitas | React · Node.js |
| [Chatbot Gemini](https://github.com/rarpen/Chatbot_gemini) | Chatbot integrado com a API do Gemini | Python |
| [Qual Vale Mais](https://github.com/rarpen/qual-vale-mais-react) | Comparador interativo em React | React · TypeScript |

> ⚠️ Ajuste os links acima caso os nomes dos repositórios no GitHub sejam diferentes dos nomes das pastas locais.
